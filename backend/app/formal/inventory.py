...
TIER_A_CLASSES: dict[str, str] = {
    ...
    "LearningService": "services/Learning.tla",
...
TIER_B_CLASSES: frozenset[str] = frozenset({
    ...
    "PracticeRun", "PracticeCriterionResult", "PracticeProgress",
...
TIER_C_PACKAGES: dict[str, str] = {
    ...
    "db_upgrade": "modules/Database.tla",
    "learning.catalog": "services/Learning.tla",
    "learning.grading": "services/Learning.tla",
    "learning.runner": "services/Learning.tla",
    "learning.workspace": "services/Learning.tla",
}
