...
CONSTANTS Namespaces, Resources
...
Next ==
    ...
    \/ \E ns \in Namespaces, r \in Resources, e \in Nat : Update(ns, r, e)
    \/ \E ns \in Namespaces, r \in Resources, e \in Nat : StaleUpdate(ns, r, e)
